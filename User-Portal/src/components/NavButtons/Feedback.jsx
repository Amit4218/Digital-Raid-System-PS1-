...
const links = [
  {
    label: "Feedback Form",
    url: "https://excise.sikkim.gov.in/FAQ/Portal_New_Feedback_Form.aspx",
  },
  {
    label: "Feedback Replies",
    url: "https://excise.sikkim.gov.in/FAQ/Portal_New_Feedback_Details_View.aspx",
  },
];
  ...
  return (
    <div className="relative">
      ...
      >
        ...
        {/* <img src="/logo.svg" alt="icon" className="w-4 h-4" /> */}
        <span>Feedback</span>
        <span className="ml-1">
      ...
      <div
        className={`absolute mt-2 bg-white text-black rounded-md shadow-lg min-w-[220px] z-10 transition-all duration-300 transform origin-top ${
          open
